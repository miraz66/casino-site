          ...
          >
            {data.resources.map((resource, index) => {
              return (
                  <div
                      key={index}
                      className="carousel-item text-center relative w-40 h-52 snap-start rounded-lg"
                  >
                    <a
                        href={resource.link}
                        className="h-full w-full rounded-lg aspect-square block bg-origin-padding bg-cover bg-center bg-no-repeat z-0"
                    ...
                    >
                      <h3 className="text-white py-6 px-3 mx-auto">
                        {resource.title}
                      </h3>
                    </a>
                  </div>
